  ...
  return (
    <div>
      ...
      <h6>
        ...
        e-commerce, cloud computing, and digital streaming. It has been referred
        to as "one of the most influential economic and cultural forces in the
        world", and is one of the world's most valuable brands.
      </h6>
      <h1>Mission Statement</h1>
      <h6>To be Earth's most customer-centric company.</h6>
      <br></br>
